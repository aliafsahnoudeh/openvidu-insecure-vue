  ...
  <div id="app">
     <div class="container">
        ...
        <div id="session" v-else>
            ...
            <div id="main-video" class="col-md-6" v-if="mainStreamManager !== undefined">
                <UserVideoComponent :streamManager="mainStreamManager" />
            </div>

            <div id="video-container" class="col-md-6">
                <div class="stream-container col-md-6 col-xs-6" 
...
const OPENVIDU_SERVER_URL = 'https://webs.shooka.com:4443';
